...
-- 发送消息途径
-- ----------------------------
INSERT INTO pcs_mec_message_notice (id, message_type_id, type, bgroup, message_send_type_id) VALUES ('GTK_CREATE', 'GTK_CREATE', 1, 'gittork', 'site');
INSERT INTO pcs_mec_message_notice (id, message_type_id, type, bgroup, message_send_type_id) VALUES ('GTK_UPDATE', 'GTK_UPDATE', 1, 'gittork', 'site');
INSERT INTO pcs_mec_message_notice (id, message_type_id, type, bgroup, message_send_type_id) VALUES ('GTK_DELETE', 'GTK_DELETE', 1, 'gittork', 'site');
INSERT INTO pcs_mec_message_notice (id, message_type_id, type, bgroup, message_send_type_id) VALUES ('GTKGP_CREATE', 'GTKGP_CREATE', 1, 'gittork', 'site');
INSERT INTO pcs_mec_message_notice (id, message_type_id, type, bgroup, message_send_type_id) VALUES ('GTKGP_UPDATE', 'GTKGP_UPDATE', 1, 'gittork', 'site');
INSERT INTO pcs_mec_message_notice (id, message_type_id, type, bgroup, message_send_type_id) VALUES ('GTKGP_DELETE', 'GTKGP_DELETE', 1, 'gittork', 'site');
