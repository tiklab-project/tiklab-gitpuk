...
public class InitAuthority implements DsmProcessTask {
    ...
    private final String[] domainAdminFunctionIds = new String[]{
           "domain_setting","domain_use","domain_role","domain_message",

            "project","repository_update","repository_delete","repository_reset",
            "code","code_create_file","code_update_file","code_update_delete","code_fork",
            "branch","branch_add","branch_delete","branch_cute",
            "merge","merge_add","merge_delete","merge_comment","merge_comment_delete",
            "code_scan","code_scan_add","code_scan_delete",
            "ci_cd","ci_cd_add","ci_cd_delete","repo_clean_exec","merge_setting_add",
            "merge_setting","lfs","lfs_delete",
            "push_setting","push_setting_add","push_setting_delete","repo_clean",
            "web_hook","web_hook_add","web_hook_update","web_hook_delete",
            "repo_mirror","repo_mirror_add","repo_mirror_update","repo_mirror_delete","repo_mirror_push",
