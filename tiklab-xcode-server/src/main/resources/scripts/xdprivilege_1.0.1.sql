...
INSERT INTO pcs_prc_function (id,name,code,parent_function_id,sort,type) VALUES ('xprojectse','项目设置', 'xcode_setting',null ,1, 2);
INSERT INTO pcs_prc_function (id,name,code,parent_function_id,sort,type) VALUES ('xprojectuse','项目成员', 'xcode_user',null ,6, 2);
INSERT INTO pcs_prc_function (id,name,code,parent_function_id,sort,type) VALUES ('xprojectde','删除项目', 'xcode_delete','projectall' ,2, 2);
INSERT INTO pcs_prc_function (id,name,code,parent_function_id,sort,type) VALUES ('xprojectup','修改项目', 'xcode_update','projectall' ,3, 2);
