...
public class CodeScanSonarServiceImpl implements CodeScanSonarService {
    ...
    @Override
    public String codeScanBySonar(String scanPlayId) {
        ...
        executorService.submit(new Runnable(){
            ...
            public void run() {
                ...
                try {
                    ...
                    if (CollectionUtils.isEmpty(deployServerList)){
                    ...
                    String mavenAddress="/Users/limingliang/Downloads/apache-maven-3.8.7/bin";
                    logger.info("sonar扫描->推送sonar");
                    Process  process = RepositoryUtil.process(mavenAddress, order);
                    //读取执行日志
                    readFile(process);
    ...
    public void scanRecord(ScanPlay scanPlay,String state) {
        ...
        try {
            if (("fail").equals(state)){
                ...
                if (CollectionUtils.isNotEmpty(arrayList)){
                    ...
                    for (Object obj:severities){
                        ...
                        if (("MAJOR").equals(map.get("val"))){
                            scanRecord.setWarnTrouble(Integer.valueOf(map.get("count").toString()));
                        }
                ...
                scanRecord.setScanResult(status);
