...
import io.tiklab.xcode.scan.model.CodeScanInstanceQuery;
import io.tiklab.xcode.scan.service.CodeScanInstanceService;
...
public class CodeScanInstanceController {
    ...
    @Autowired
    private CodeScanInstanceService codeScanInstanceService;
