...
@Api(name = "CodeGroupController",desc = "仓库组")
public class CodeGroupController {

    @Autowired
    private CodeGroupServer groupServer;
    ...
    public Result<String> createGroup(@RequestBody @NotNull @Valid CodeGroup group){
    ...
    @ApiParam(name = "code",desc = "code",required = true)
    public Result<Void> updateGroup(@RequestBody @NotNull @Valid CodeGroup group){
    ...
    public Result<List<CodeGroup>> findUserGroup(@NotNull String userId){

        List<CodeGroup> codeList = groupServer.findUserGroup(userId);
